...
public class Convertor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userInput = findViewById(R.id.inputText1);
        resultTextView = findViewById(R.id.sonuc1);
        ...
        userInput2 = findViewById(R.id.inputText2);
        resultTextView2 = findViewById(R.id.sonuc2);
        ...
        userInput3 = findViewById(R.id.inputText3);
        resultTextView3 = findViewById(R.id.sonuc3);
        radioGroup = findViewById(R.id.radioGroup);

        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int radioGroup) {
                RadioButton tiklananButon = findViewById(radioGroup);
    ...
    private void convertAndDisplayResult3(String userInputValue3, String conversionType){
        if(userInputValue3.isEmpty()){
            Toast.makeText(getApplicationContext(),"lütfen boş değer girmeyin",Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        try {
            ...
            String sonuc3="";
            if(conversionType.equals("Fahrenayt")){

            double fahrenayt = (tempature *9/5)+32;
            sonuc3 = String.valueOf(fahrenayt);

            } else if (conversionType.equals("Kelvin")) {

                double kelvin = tempature +273.15;
                sonuc3 = String.valueOf(kelvin);
            }
            resultTextView3.setText(sonuc3);
        }
        catch (NumberFormatException e){
